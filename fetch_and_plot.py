...
# ── VWAP proximity alert ─────────────────────────────────────────────────────

VWAP_PROXIMITY = 0.5   # points — alert when |close - vwap| <= this
...
def main():
    ...
    # ── Telegram VWAP proximity alert (every run) ─────────────────────────────
    print(f"\n── Checking VWAP Proximity ─────────────────────────────────────")
    if not args.no_telegram:
        check_vwap_proximity(ce_data, pe_data, fetch_date, run_time)
    else:
        print("  [vwap prox] skipped via --no-telegram")
